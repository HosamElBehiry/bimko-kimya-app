...
export const Footer = async () => {
  ...
  return (
    <footer className="bg-[#8cc543] pt-15 sm:pt-20 lg:pt-40 pb-3 sm:pb-5 lg:pb-10">
      ...
      <div className="border-t container mx-auto pt-3 sm:pt-5 lg:pt-10 max-md:px-5 border-t-white">
